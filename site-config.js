...
module.exports = {
  ...
  instagram_username: "sethgoesflying",
  twitter_username: "sethwebster",
  ...
  features: [
    {
      title: "Split Time",
      description: "Take to the skies and share the expense, splitting costs.",
      fontawesome_icon_name: "money-bill-wave",
    },
    {
    ...
    },
    {
      ...
      description:
        "Take off with fellow aviation enthusiasts and build new friendships.",
